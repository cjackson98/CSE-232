...
int main(){
    ...
    Market mrkt("proj08/dow.txt");
    Player p1(1000);
    Player p2(1000);
    p1.buy(mrkt,"AA",20120831,5);
    p1.buy(mrkt,"AXP",20120831,5);
    p2.buy(mrkt, "BA",20120831,10);
    auto p = p1.combine(p2);
    string s = p.to_str();
    string ans = "952.85,AA:5,AXP:5,BA:10";
    cout<<s<<endl;
    cout<<ans<<endl;//ASSERT_EQ(s,ans);
    cout<<p1.cash<<" : "<<0.0<<endl;//ASSERT_EQ(p1.cash, 0.0);
    cout<<p1.cash<<" : "<<0.0<<endl;//ASSERT_EQ(p2.cash, 0.0);
